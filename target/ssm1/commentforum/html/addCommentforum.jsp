...
<div class="container" style="height: 1000px">
    <center><h3>添加论坛评论页面</h3></center>
    <form action="${pageContext.request.contextPath}/commentforum/addcommentforum" method="post">
        <div class="form-group">
            <label for="cfno">编号：</label>
            <input type="text" class="form-control" id="cfno" name="cfno" placeholder="请输入编号">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control layui-input" id="rno" name="rno" placeholder="请输入论坛编号">
        </div>

        <div class="form-group">
            <label for="cfname">评论人：</label>
            <input type="text" class="form-control" id="cfname" name="cfname" placeholder="请输入评论人">
        </div>
        <div class="form-group">
            <label for="cftime">时间：</label>
            <input type="date" class="form-control" id="cftime" name="cftime" placeholder="请输入评论时间">
        </div>
        <div class="form-group">
            <label for="cfcontent">评论内容：</label>
            <input type="text" class="form-control" id="cfcontent" name="cfcontent" placeholder="请输入内容">
        </div>
