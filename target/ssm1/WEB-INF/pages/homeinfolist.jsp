...
<div class="x-nav">
            <span class="layui-breadcrumb">
              <a><cite>首页</cite></a>
              <a><cite>家庭住址信息管理</cite></a>
              <a><cite>家庭住址信息</cite></a>
            </span>
</div>
<!-- banner部分 -->
<div class="container">
    <h3 style="text-align: center">家庭住址信息列表</h3>
    <div style="float: left;">
        <form class="form-inline" id="qf" action="${pageContext.request.contextPath}/homeinfo/findall" method="post">
    ...
    <div style="float: right;margin: 5px;">
        <a class="btn btn-primary" href="${pageContext.request.contextPath}/homeinfo/html/addHomeInfo.jsp">添加家庭住址信息</a>
    </div>
...
<script>
    ...
    $(".xiugai").click(function(){
        var hno = $(this).parents("tr").find("td:eq(0)").text();
        alert("确定修改家庭住址"+hno+"吗?");
        //window.location.href='/page/edit?page=updateHomeInfo&&hno='+hno;
        window.location.href='${pageContext.request.contextPath}/homeinfo/queryKey?hno='+hno;
    })
    ...
    $(".delete").click(function(){
        //获取要删除用户的名字
        var hno = $(this).parents("tr").find("td:eq(0)").text();
        alert("确定删除家庭住址"+hno+"吗?");
        window.location.href='${pageContext.request.contextPath}/homeinfo/delete?hno='+hno;
    })
</script>
