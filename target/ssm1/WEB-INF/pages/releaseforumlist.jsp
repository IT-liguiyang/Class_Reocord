...
<div class="x-nav">
            <span class="layui-breadcrumb">
              <a><cite>首页</cite></a>
              <a><cite>论坛管理</cite></a>
              <a><cite>发布论坛管理</cite></a>
            </span>
</div>
<!-- banner部分 -->
<div class="container">
    <h3 style="text-align: center">论坛信息列表</h3>
    <div style="float: left;">
        <form class="form-inline" id="qf" action="${pageContext.request.contextPath}/releaseforum/findall" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="rcontent" class="form-control" id="rcontent">
            </div>
    ...
    <div style="float: right;margin: 5px;">
        <a class="btn btn-primary" href="${pageContext.request.contextPath}/releaseforum/html/addReleaseforum.jsp">添加论坛信息</a>
    </div>
    ...
    <table border="1" class="table table-bordered table-hover">
        ...
        <c:forEach items="${pageInfo.list}" var="rf">
            <tr>
                <td>${rf.rno}</td>
                <td>${rf.username}</td>
                <td>${rf.rname}</td>
                ...
                <td>
                    <fmt:formatDate value="${rf.rtime}" pattern="yyyy-MM-dd"/>
                </td>
...
<script>
    ...
    $(".xiugai").click(function(){
        ...
        alert("确定修改论坛"+rno+"吗?");
        //window.location.href='/page/edit?page=updateReleaseforum&&rno='+rno;
        window.location.href='${pageContext.request.contextPath}/releaseforum/queryKey?rno='+rno;
    })
    ...
    $(".delete").click(function(){
        ...
        var rno = $(this).parents("tr").find("td:eq(0)").text();
        alert("确定删除论坛"+rno+"吗?");
        window.location.href='${pageContext.request.contextPath}/releaseforum/delete?rno='+rno;
    })
</script>
