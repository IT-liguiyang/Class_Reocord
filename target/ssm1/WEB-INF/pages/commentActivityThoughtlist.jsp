...
<div class="x-nav">
            <span class="layui-breadcrumb">
              <a><cite>首页</cite></a>
              <a><cite>评论活动感想管理</cite></a>
              <a><cite>评论活动感想信息</cite></a>
            </span>
</div>
<!-- banner部分 -->
<div class="container">
    <h3 style="text-align: center">评论活动感想信息列表</h3>
    <div style="float: left;">
        <form class="form-inline" id="qf" action="${pageContext.request.contextPath}/commentActivityThought/findall" method="post">
            ...
            <div class="form-group">
                <label for="cacontent">评论活动感想</label>
                <input type="text" name="cacontent" class="form-control" id="cacontent">
            </div>
    ...
    <div style="float: right;margin: 5px;">
        <a class="btn btn-primary" href="${pageContext.request.contextPath}/commentActivityThought/html/addCommentActivityThought.jsp">添加活动感想评论信息</a>
    </div>
    ...
    <table border="1" class="table table-bordered table-hover">
        ...
        <c:forEach items="${pageInfo.list}" var="cat">
            <tr>
                ...
                <td>
                    <fmt:formatDate value="${cat.catime}" pattern="yyyy-MM-dd"/>
                </td>
...
<script>
    ...
    $(".xiugai").click(function(){
        var cano = $(this).parents("tr").find("td:eq(0)").text();
        alert("确定修改"+cano+"吗?");
        //window.location.href='/page/edit?page=updateCommentActivityThought&&cano='+cano;
        window.location.href='${pageContext.request.contextPath}/commentActivityThought/queryKey?cano='+cano;
    })
    ...
    $(".delete").click(function(){
        ...
        var cano = $(this).parents("tr").find("td:eq(0)").text();
        alert("确定删除工作"+cano+"吗?");
        window.location.href='${pageContext.request.contextPath}/commentActivityThought/delete?cano='+cano;
    })
</script>
