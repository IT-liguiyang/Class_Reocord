...
<div class="container" style="height: 1000px">
    <center><h3>添加感想页面</h3></center>
    <form action="${pageContext.request.contextPath}/thought/addthought" method="post">
        <div class="form-group">
            <label for="atno">编号：</label>
            <input type="text" class="form-control" id="atno" name="atno" placeholder="请输入活动编号">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="date" class="form-control layui-input" id="attime" name="attime" placeholder="请输入活动时间">
        </div>

        <div class="form-group">
            <label for="atcontent">活动内容：</label>
            <input type="text" class="form-control" id="atcontent" name="atcontent" placeholder="请输入活动内容">
        </div>

        <div class="form-group">
            <label for="atname">发布者：</label>
            <input type="text" class="form-control" id="atname" name="atname" placeholder="请输入发布者">
        </div>
