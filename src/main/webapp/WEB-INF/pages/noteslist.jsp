...
<div class="x-nav">
            <span class="layui-breadcrumb">
              <a><cite>首页</cite></a>
              <a><cite>班级通知管理</cite></a>
              <a><cite>班级通知列表</cite></a>
            </span>
</div>
<!-- banner部分 -->
<div class="container">
    ...
    <div style="float: left;">
        <form class="form-inline" id="qf" action="${pageContext.request.contextPath}/notes/findall" method="post">
            ...
            <div class="form-group">
                <label for="cnsubject">主题</label>
                <input type="text" name="cnsubject"  class="form-control" id="cnsubject">
            </div>
    ...
    <div style="float: right;margin: 5px;">
        <a class="btn btn-primary" href="${pageContext.request.contextPath}/notes/html/add.jsp">添加班级通知</a>
    </div>
...
<script>
    ...
    $(".xiugai").click(function(){
        var cnno = $(this).parents("tr").find("td:eq(0)").text();
        alert("确定修改"+cnno+"吗?");
        window.location.href='${pageContext.request.contextPath}/notes/querykey?cnno='+cnno;
    })
    ...
    $(".delete").click(function(){
        ...
        var cnno = $(this).parents("tr").find("td:eq(0)").text();
        alert("确定删除用户"+cnno+"吗?");
        window.location.href='${pageContext.request.contextPath}/notes/delete?cnno='+cnno;
    })
