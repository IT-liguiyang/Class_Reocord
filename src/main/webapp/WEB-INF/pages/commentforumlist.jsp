...
<div class="x-nav">
            <span class="layui-breadcrumb">
              <a><cite>首页</cite></a>
              <a><cite>论坛信息管理</cite></a>
              <a><cite>论坛评论信息</cite></a>
            </span>
</div>
<!-- banner部分 -->
<div class="container">
    <h3 style="text-align: center">论坛评论信息列表</h3>
    <div style="float: left;">
        <form class="form-inline" id="qf" action="${pageContext.request.contextPath}/work/findall" method="post">
            ...
            <div class="form-group">
                <label for="cfcontent">工作地点</label>
                <input type="text" name="cfcontent" class="form-control" id="cfcontent">
            </div>
    ...
    <div style="float: right;margin: 5px;">
        <a class="btn btn-primary" href="${pageContext.request.contextPath}/commentforum/html/addCommentforum.jsp">添加论坛评论信息</a>
    </div>
    ...
    <table border="1" class="table table-bordered table-hover">
        ...
        <c:forEach items="${pageInfo.list}" var="cf">
            <tr>
                ...
                <td>
                    <fmt:formatDate value="${cf.cftime}" pattern="yyyy-MM-dd"/>
                </td>
...
<script>
    ...
    $(".xiugai").click(function(){
        var cfno = $(this).parents("tr").find("td:eq(0)").text();
        alert("确定修改"+cfno+"吗?");
        //window.location.href='/page/edit?page=updateCommentforum&&cfno='+cfno;
        window.location.href='${pageContext.request.contextPath}/commentforum/queryKey?cfno='+cfno;
    })
    ...
    $(".delete").click(function(){
        ...
        var cfno = $(this).parents("tr").find("td:eq(0)").text();
        alert("确定删除"+cfno+"吗?");
        window.location.href='${pageContext.request.contextPath}/commentforum/delete?cfno='+cfno;
    })
</script>
