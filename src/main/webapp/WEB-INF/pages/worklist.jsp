...
<div class="x-nav">
            <span class="layui-breadcrumb">
              <a><cite>首页</cite></a>
              <a><cite>工作信息管理</cite></a>
              <a><cite>工作信息</cite></a>
            </span>
</div>
<!-- banner部分 -->
<div class="container">
    <h3 style="text-align: center">工作信息列表</h3>
    <div style="float: left;">
        <form class="form-inline" id="qf" action="${pageContext.request.contextPath}/work/findall" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="comaddress" class="form-control" id="comaddress">
            </div>
    ...
    <div style="float: right;margin: 5px;">
        <a class="btn btn-primary" href="${pageContext.request.contextPath}/work/html/addWork.jsp">添加工作信息</a>
    </div>
...
<script>
    ...
    $(".xiugai").click(function(){
        var comno = $(this).parents("tr").find("td:eq(0)").text();
        alert("确定修改工作"+comno+"吗?");
        //window.location.href='/page/edit?page=updateWork&&comno='+comno;
        window.location.href='${pageContext.request.contextPath}/work/queryKey?comno='+comno;
    })
    ...
    $(".delete").click(function(){
        //获取要删除用户的名字
        var comno = $(this).parents("tr").find("td:eq(0)").text();
        alert("确定删除工作"+comno+"吗?");
        window.location.href='${pageContext.request.contextPath}/work/delete?comno='+comno;
    })
</script>
