...
<div class="x-nav">
            <span class="layui-breadcrumb">
              ...
              <a><cite>班级活动列表</cite></a>
            </span>
</div>
<!-- banner部分 -->
<div class="container">
    <h3 style="text-align: center">班级活动列表</h3>
    <div style="float: left;">
        <form class="form-inline" id="qf" action="${pageContext.request.contextPath}/activity/findall" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="aplace"  class="form-control" id="aplace">
            </div>
    ...
    <div style="float: right;margin: 5px;">
        <a class="btn btn-primary" href="${pageContext.request.contextPath}/activity/html/addActivity.jsp">添加活动</a>
    </div>
    ...
    <table border="1" class="table table-bordered table-hover">
        ...
        <c:forEach items="${pageInfo.list}" var="at">
            <tr>
                ...
                <td>
                    <fmt:formatDate value="${at.atime}" pattern="yyyy-MM-dd"/>
                </td>
...
<script>
    ...
    $(".xiugai").click(function(){
        var ano = $(this).parents("tr").find("td:eq(0)").text();
        alert(ano);
        //window.location.href='/page/edit?page=updateactivity&&ano='+ano;
        window.location.href='${pageContext.request.contextPath}/activity/querykey?ano='+ano;
    })
    ...
    $(".delete").click(function(){
        ...
        var ano = $(this).parents("tr").find("td:eq(0)").text();
        alert("确定删除用户"+ano+"吗?");
        window.location.href='${pageContext.request.contextPath}/activity/delete?ano='+ano;
    })
